(function () {
  ...
  function addProbeStyle() {
    ...
    style.textContent = ""
      ...
      + "--lua-probe-surface-shine:rgba(255,255,255,0.02);"
      + "--lua-probe-elevation-shadow:rgba(0,0,0,0.25);"
      ...
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine),0 1px 0 var(--lua-probe-elevation-shadow),var(--lua-probe-shadow) 3px 3px 5px !important;}"
      ...
      + "#dpu_editor[data-lua-probe-active=\"1\"] .main_wrapper .wrapper .editor_wrapper .col.scripts .error_ctn .header .lua_error_header_wrapper .lua_error_title,"
      ...
      + "font-family:Play,sans-serif !important;font-size:17.18888855px !important;font-weight:600 !important;line-height:20px !important;text-transform:uppercase;"
      + "text-shadow:0 1px 0 rgba(0,0,0,0.42) !important;}"
      + "#dpu_editor[data-lua-probe-active=\"1\"] .main_wrapper .wrapper .editor_wrapper .col.scripts .error_ctn .header .lua_error_header_wrapper .lua-probe-buffer-size{"
      + "flex:1 1 auto;margin-left:16px;}"
      ...
      + "flex:0 0 auto;}"
      + "#inventory #ModUiToolbox-inventory-theme-host{"
      + "position:absolute;left:8px;top:-22px;z-index:25;display:block;overflow:visible;pointer-events:auto;}"
      + "#inventory #ModUiToolbox-inventory-theme-dots{"
      + "position:absolute;left:0;right:auto;top:0;transform:none;display:flex;gap:0;align-items:center;z-index:11;overflow:visible;flex:0 0 auto;margin:0;}"
      ...
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25));}"
      ...
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 4px 10px rgba(0,0,0,0.18);}"
      ...
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 4px 10px rgba(0,0,0,0.16);}"
      ...
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 0 0 1px rgba(0,0,0,0.22),0 0 8px rgba(160,38,38,0.28);}"
      ...
      + "border:1px solid var(--lua-probe-accent) !important;box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 10px 26px rgba(0,0,0,0.42);}"
      ...
      + "box-shadow:inset 0 1px 0 rgba(255,255,255,0.04),inset 0 -1px 0 rgba(0,0,0,0.5) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"]{"
      + "background:var(--lua-probe-surface-main) !important;background-image:none !important;"
      + "border-right:1px solid var(--lua-probe-border-strong) !important;"
      + "box-shadow:0 0 18px var(--lua-probe-shadow) !important;color:var(--lua-probe-text-muted) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder{"
      + "background:transparent !important;background-image:none !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .toggle_menu{"
      + "background:var(--lua-probe-surface-elevated) !important;border-color:var(--lua-probe-border-strong) !important;"
      + "box-shadow:none !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .toggle_menu svg{"
      + "fill:var(--lua-probe-accent-solid) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .toggle_menu:hover{"
      + "background:var(--lua-probe-surface-row-alt) !important;border-color:var(--lua-probe-border-hover) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .toggle_menu:hover svg{"
      + "fill:var(--lua-probe-text-muted) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper{"
      + "background:transparent !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper .globalmenu_button{"
      + "background:var(--lua-probe-surface-row) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper .globalmenu_button svg{"
      + "fill:var(--lua-probe-text-muted) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper .label{"
      + "color:var(--lua-probe-text-muted) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper .shortcut{"
      + "color:var(--lua-probe-text-dim) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled):not(.selected):hover{"
      + "background:var(--lua-probe-surface-deep) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled):not(.selected):hover .globalmenu_button{"
      + "background:var(--lua-probe-surface-row-alt) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled):not(.selected):hover .globalmenu_button svg{"
      + "fill:var(--lua-probe-cm-text) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled).selected{"
      + "background:var(--lua-probe-mode-selected-bg) !important;"
      + "box-shadow:inset 0 0 0 1px var(--lua-probe-selection-border) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled).selected .globalmenu_button{"
      + "background:transparent !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled).selected .globalmenu_button svg{"
      + "fill:var(--lua-probe-mode-selected-color) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled).selected .label,"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper:not(.disabled).selected .shortcut{"
      + "color:var(--lua-probe-mode-selected-color) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .globalmenu_button,"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .label,"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .shortcut{"
      + "opacity:1 !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .globalmenu_button{"
      + "background:var(--lua-probe-btn-disabled-bg) !important;}"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .globalmenu_button svg,"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .label,"
      + ".global_inputs_wrapper[data-lua-probe-active=\"1\"] .button_holder .globalmenu_button_wrapper.disabled .shortcut{"
      + "fill:var(--lua-probe-btn-disabled-color) !important;color:var(--lua-probe-btn-disabled-color) !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu{"
      + "background:transparent !important;box-shadow:none !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu > ul,"
      + "body[data-lua-probe-active=\"1\"] .context_menu ul{"
      + "margin:0 !important;padding:4px 0 !important;list-style:none !important;"
      + "background:var(--lua-probe-surface-backdrop) !important;border:1px solid var(--lua-probe-border-strong) !important;"
      + "box-shadow:0 10px 26px var(--lua-probe-shadow) !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu{"
      + "display:flex !important;align-items:stretch !important;min-height:40px !important;background:transparent !important;border:0 !important;box-shadow:none !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu > a{"
      + "display:flex !important;align-items:center !important;width:100% !important;padding:10px 18px !important;"
      + "min-height:40px !important;box-sizing:border-box !important;"
      + "background:transparent !important;color:var(--lua-probe-text-muted) !important;-webkit-text-fill-color:var(--lua-probe-text-muted) !important;"
      + "text-shadow:none !important;text-decoration:none !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu .shortCut,"
      + "body[data-lua-probe-active=\"1\"] .context_menu .shortCut kbd{"
      + "color:#111111 !important;-webkit-text-fill-color:#111111 !important;text-shadow:none !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.right_dropdown > a > svg.icon{"
      + "transform:translateY(-2px) !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu:hover,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu:hover > a,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.selected,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.selected > a{"
      + "background:var(--lua-probe-text-muted) !important;color:var(--lua-probe-surface-backdrop) !important;-webkit-text-fill-color:var(--lua-probe-surface-backdrop) !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu:hover .shortCut,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu:hover .shortCut kbd,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.selected .shortCut,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.selected .shortCut kbd{"
      + "color:#111111 !important;-webkit-text-fill-color:#111111 !important;text-shadow:none !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu:hover .shortCut kbd,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.selected .shortCut kbd{"
      + "background-color:rgb(250, 212, 122) !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.disabled,"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu.disabled > a{"
      + "background:transparent !important;color:var(--lua-probe-btn-disabled-color) !important;-webkit-text-fill-color:var(--lua-probe-btn-disabled-color) !important;}"
      + "body[data-lua-probe-active=\"1\"] .context_menu li.menu + li.menu{"
      + "border-top:1px solid var(--lua-probe-border-strong) !important;}"
      ...
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeBankSubPanel_wrapper{"
      + "background:var(--lua-probe-surface-backdrop) !important;background-image:none !important;color:var(--lua-probe-text-muted) !important;}"
      ...
      + "background:var(--lua-probe-surface-elevated) !important;border-color:var(--lua-probe-border-strong) !important;"
      + "color:var(--lua-probe-text-muted) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .search_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .ingredient_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .action_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .recipes_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drilldown_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_entry,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .item_list_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_cell_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sum_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .container_layout,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .container_layout_wrapper,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .container_header,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .container_footer,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .itemset_tabs_list,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .itemset_body,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .items_slots_grid,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .title_wrapper,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .dropdown,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .searchbox_component{"
      + "background:var(--lua-probe-surface-elevated) !important;background-image:none !important;"
      + "border-color:var(--lua-probe-border-strong) !important;color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .item_tree_component .item_line,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drillDownElementWrapper,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drilldown_root,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drilldownElementBody,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drilldownElement,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .dropdown li,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid .line,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid .container_row,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid .container_cell,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid .containers_sum_line,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .itemset_button{"
      + "background:var(--lua-probe-surface-row) !important;border-color:var(--lua-probe-border-strong) !important;"
      + "color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid .container_cell,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .containers_sub_grid .containers_sum_line{"
      + "background-clip:padding-box !important;box-shadow:inset 0 -1px 0 var(--lua-probe-border-strong) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .select_recipe_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .search_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .ingredient_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .recipes_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .drilldown_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .action_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .only_available_line,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeSubPanel_wrapper .only_doable_line,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper .sub_panel_job,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper .checkbox_area,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_recipeBankSubPanel_wrapper .containers_area{"
      + "background:var(--lua-probe-surface-backdrop) !important;background-image:none !important;color:var(--lua-probe-text-muted) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper .container_cell.modui-zero-shortage,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper .containers_sum_line.modui-zero-shortage{"
      + "background:rgba(130,36,36,0.88) !important;border-color:rgba(255,185,185,0.92) !important;"
      + "box-shadow:inset 0 -1px 0 rgba(255,185,185,0.92) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper .container_cell.modui-zero-shortage .value,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_containersSubPanel_wrapper .containers_sum_line.modui-zero-shortage{"
      + "color:#ffffff !important;fill:#ffffff !important;-webkit-text-fill-color:#ffffff !important;text-shadow:none !important;opacity:1 !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .item_tree_component .item_line:hover,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .dropdown li:hover,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .itemset_button:hover{"
      + "background:var(--lua-probe-surface-row-alt) !important;border-color:var(--lua-probe-border-hover) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .item_tree_component .item_line.selected,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .item_tree_component .item_line.have_selection{"
      + "background:var(--lua-probe-mode-selected-bg) !important;border-color:var(--lua-probe-mode-selected-border) !important;"
      + "color:var(--lua-probe-mode-selected-color) !important;"
      + "box-shadow:inset 0 0 0 1px var(--lua-probe-selection-border) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .dropdown li.selected,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .itemset_button.selected,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .itemset_button.drop-zone.selected{"
      + "background:var(--lua-probe-mode-selected-bg) !important;border-color:var(--lua-probe-mode-selected-border) !important;"
      + "color:var(--lua-probe-mode-selected-color) !important;"
      + "box-shadow:inset 0 0 0 1px var(--lua-probe-selection-border) !important;}"
      ...
      + "color:var(--lua-probe-btn-apply-color) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .searchbox_component .search_box,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .searchbox_component input{"
      + "background:var(--lua-probe-surface-main) !important;border-color:var(--lua-probe-border-strong) !important;"
      + "color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .searchbox_component .search_box,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .searchbox_component input,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .dropdown_selection_label,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .dropdown_no_search_result,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .wrapper-dropdown .element_label,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drilldown_label,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_entry .label,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .switch_label,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .information_message,"
      ...
      + "#industry_panel[data-lua-probe-active=\"1\"] .search_icon,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .remove_search,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .clear_search_box,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .display_all_item_help,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .drillDownSvgWrapper svg,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .important_message_component .icon_information{"
      + "fill:var(--lua-probe-text-muted) !important;color:var(--lua-probe-text-muted) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .right_arrow .arrow,"
      ...
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_switch{"
      + "background:var(--lua-probe-surface-row-alt) !important;border-color:var(--lua-probe-border-strong) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_switch .slider{"
      + "background:var(--lua-probe-btn-cancel-bg) !important;border-color:var(--lua-probe-btn-apply-border) !important;"
      + "box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_component .checkbox_input,"
      + "#industry_panel[data-lua-probe-active=\"1\"] input.checkbox{"
      + "background:var(--lua-probe-surface-row) !important;border-color:var(--lua-probe-border-strong) !important;"
      + "color:var(--lua-probe-text-muted) !important;outline-color:var(--lua-probe-border-strong) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_component .checkbox_input:checked,"
      + "#industry_panel[data-lua-probe-active=\"1\"] input.checkbox:checked{"
      + "background:var(--lua-probe-accent-solid) !important;border-color:var(--lua-probe-accent-solid) !important;"
      + "outline-color:var(--lua-probe-accent-solid) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_switch .switch_label{"
      + "color:var(--lua-probe-text-dim) !important;text-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_switch input:checked ~ .checked_option,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .checkbox_switch input:not(:checked) ~ .unchecked_option{"
      ...
      + "color:#f4efe7 !important;fill:#f4efe7 !important;opacity:1 !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .mask_no_change_recipe_selected,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .mask_no_active_recipe,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .no_recipe_mask,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .important_message_component{"
      + "background:var(--lua-probe-surface-elevated) !important;background-image:none !important;"
      + "border:1px solid var(--lua-probe-border-strong) !important;color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .description_mode,"
      ...
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area{"
      + "background:var(--lua-probe-surface-backdrop) !important;background-image:none !important;"
      + "border-top:1px solid var(--lua-probe-border-strong) !important;color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .progression_bar_block,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .stats_block{"
      + "background:transparent !important;border-color:var(--lua-probe-border-strong) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .stats_entry,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .info_output{"
      + "background:transparent !important;border-color:var(--lua-probe-border-strong) !important;"
      + "color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .stats_entry .label,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .info_output .title{"
      + "color:var(--lua-probe-text-dim) !important;text-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .stats_entry .value,"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .info_output .value{"
      + "color:var(--lua-probe-text-muted) !important;text-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .progression_bar{"
      + "background:var(--lua-probe-surface-row) !important;border:1px solid var(--lua-probe-border-strong) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] .footer_area .progression_bar .inner_progress_bar{"
      ...
      + "-webkit-text-fill-color:currentColor !important;text-shadow:none !important;opacity:1 !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMakeArea,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMaintainArea{"
      + "color:var(--lua-probe-text-muted) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMakeArea .input_amount,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMaintainArea .input_amount{"
      + "background:var(--lua-probe-surface-main) !important;border-color:var(--lua-probe-border-strong) !important;"
      + "color:var(--lua-probe-text-muted) !important;box-shadow:none !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMakeArea input,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMaintainArea input{"
      + "color:var(--lua-probe-text-muted) !important;background:transparent !important;opacity:1 !important;"
      + "-webkit-text-fill-color:currentColor !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMakeArea *,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_inputMaintainArea *{"
      + "color:var(--lua-probe-text-muted) !important;fill:currentColor !important;stroke:none !important;"
      + "-webkit-text-fill-color:currentColor !important;text-shadow:none !important;opacity:1 !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake.selected #industryPanel_productionSubPanel_inputMakeArea,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain.selected #industryPanel_productionSubPanel_inputMaintainArea{"
      + "color:var(--lua-probe-cm-text) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake.selected #industryPanel_productionSubPanel_inputMakeArea .input_amount,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain.selected #industryPanel_productionSubPanel_inputMaintainArea .input_amount{"
      + "color:var(--lua-probe-cm-text) !important;border-color:rgba(255,255,255,0.22) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake.selected #industryPanel_productionSubPanel_inputMakeArea input,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain.selected #industryPanel_productionSubPanel_inputMaintainArea input,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake.selected #industryPanel_productionSubPanel_inputMakeArea input:disabled,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain.selected #industryPanel_productionSubPanel_inputMaintainArea input:disabled{"
      + "color:var(--lua-probe-cm-text) !important;background:transparent !important;opacity:1 !important;"
      + "-webkit-text-fill-color:currentColor !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake.selected #industryPanel_productionSubPanel_inputMakeArea *,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain.selected #industryPanel_productionSubPanel_inputMaintainArea *{"
      + "color:var(--lua-probe-cm-text) !important;fill:currentColor !important;-webkit-text-fill-color:currentColor !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeRunInfinity:hover:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake:hover:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain:hover:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_startButton:hover:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_finishButton:hover:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_stopButton:hover:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_claimProductsApplyButton:hover:not(.disabled){"
      + "border-color:var(--lua-probe-border-hover) !important;background:var(--lua-probe-btn-cancel-hover-bg) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_startButton:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_finishButton:not(.disabled),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_stopButton:not(.disabled){"
      + "color:var(--lua-probe-cm-text) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_finishButton:not(.disabled){"
      + "border-color:var(--lua-probe-cm-builtin) !important;color:var(--lua-probe-cm-builtin) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_claimProductsApplyButton:not(.disabled){"
      + "border-color:var(--lua-probe-btn-apply-border) !important;background:var(--lua-probe-btn-apply-bg) !important;"
      + "color:var(--lua-probe-btn-apply-color) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeRunInfinity.disabled:not(.selected),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMake.disabled:not(.selected),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_modeMaintain.disabled:not(.selected),"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_startButton.disabled,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_finishButton.disabled,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_stopButton.disabled,"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_claimProductsApplyButton.disabled{"
      + "border-color:var(--lua-probe-btn-disabled-border) !important;background:var(--lua-probe-btn-disabled-bg) !important;"
      + "color:var(--lua-probe-btn-disabled-color) !important;box-shadow:none !important;}"
      ...
      + "background:var(--lua-probe-accent-solid) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_progressionBar.stopped #industryPanel_productionSubPanel_innerProgressionBar{"
      + "background:var(--lua-probe-text-dim) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_progressionBar.running #industryPanel_productionSubPanel_innerProgressionBar{"
      + "background:var(--lua-probe-btn-apply-bg) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_progressionBar.stopping #industryPanel_productionSubPanel_innerProgressionBar{"
      + "background:var(--lua-probe-cm-variable-2) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_progressionBar.jammed #industryPanel_productionSubPanel_innerProgressionBar{"
      + "background:var(--lua-probe-cm-keyword) !important;}"
      + "#industry_panel[data-lua-probe-active=\"1\"] #industryPanel_productionSubPanel_progressionBar.pending #industryPanel_productionSubPanel_innerProgressionBar{"
      + "background:var(--lua-probe-cm-builtin) !important;}"
      ...
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),inset 0 -2px 0 rgba(0,0,0,0.46),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 3px 10px rgba(0,0,0,0.28);"
      + "transition:background-color 0.14s ease,border-color 0.14s ease,color 0.14s ease,box-shadow 0.14s ease,transform 0.05s ease;}"
      ...
      + "background:var(--lua-probe-btn-apply-bg) !important;"
      + "text-shadow:0 1px 0 rgba(0,0,0,0.42),0 0 1px rgba(0,0,0,0.35) !important;"
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),inset 0 -2px 0 rgba(0,0,0,0.4),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 3px 10px rgba(0,0,0,0.3) !important;"
      + "transition:background 0.14s ease,border-color 0.14s ease,color 0.14s ease,box-shadow 0.14s ease,transform 0.05s ease;}"
      ...
      + "background:var(--lua-probe-btn-cancel-bg) !important;"
      + "text-shadow:0 1px 0 rgba(0,0,0,0.42),0 0 1px rgba(0,0,0,0.35) !important;"
      + "box-shadow:inset 0 1px 0 var(--lua-probe-surface-shine,rgba(255,255,255,0.02)),inset 0 -2px 0 rgba(0,0,0,0.46),0 1px 0 var(--lua-probe-elevation-shadow,rgba(0,0,0,0.25)),0 3px 10px rgba(0,0,0,0.28) !important;"
      + "transition:background 0.14s ease,border-color 0.14s ease,color 0.14s ease,box-shadow 0.14s ease,transform 0.05s ease;}"
...
function ensureInventoryThemeStyle() {
  ...
  var cssText = ""
    ...
    + "color:var(--lua-probe-warning) !important;-webkit-text-fill-color:var(--lua-probe-warning) !important;font-weight:700 !important;text-shadow:none !important;}"
    ...
    + "display:none !important;}"
    + popupInspectorRootSelector + " .modui-inventory-inspector-summary .item_inspector_window_input.open_in_new_inspector_button{"
    + "display:none !important;}"
...
function teardownInventoryInspectorEnhancer(root, includePopupInspectors) {
  var wrappers;
  var i;
  var selector;
  if (!root || !root.querySelectorAll) {
  ...
  selector = includePopupInspectors === false
    ? ".selected_item_inspector_wrapper .item_inspector_wrapper"
    : ".selected_item_inspector_wrapper .item_inspector_wrapper, .basic_window.item_inspector_win .item_inspector_wrapper";
  wrappers = root.querySelectorAll(selector);
  for (i = 0; i < wrappers.length; i += 1) {
    resetInventoryInspectorWrapper(wrappers[i]);
  }
}

function syncSingleInventoryInspector(inspector) {
  var wrapper;
  var header;
  var content;
  var info;
  ...
  if (!inspector || !inspector.querySelector) {
    return;
  }

  state.inventoryInspectorCollapsed = getInventoryInspectorCollapsed(inspector);

  wrapper = inspector.querySelector(".item_inspector_wrapper");
...
function buildVisiblePopupInventoryInspectorSyncToken() {
  var inspectors = document.querySelectorAll(".basic_window.item_inspector_win");
  var tokens = [];
  var wm = window.windowsManager && Array.isArray(window.windowsManager.windows) ? window.windowsManager.windows : [];
  var i;
  for (i = 0; i < inspectors.length; i += 1) {
    ...
    var entry = null;
    var j;
    if (!isElementVisible(inspector)) {
      continue;
    }
    wrapper = inspector.querySelector(".item_inspector_wrapper");
    titleNode = inspector.querySelector(".header_wrapper .item_longname") || inspector.querySelector(".item_longname");
    summary = wrapper ? wrapper.querySelector(".modui-inventory-inspector-summary") : null;
    topPanel = wrapper ? wrapper.querySelector(".modui-inventory-inspector-top-panel") : null;
    for (j = 0; j < wm.length; j += 1) {
      if (wm[j] && wm[j].win === inspector) {
        entry = wm[j];
        break;
      }
    }
    tokens.push([
      titleNode ? String(titleNode.textContent || "").trim() : "",
      summary ? "1" : "0",
      topPanel ? "1" : "0",
      inspector.getAttribute("data-modui-inventory-inspector-collapsed") || "",
      entry && entry.options ? String(entry.options.maxHeight || "") : ""
    ].join("|"));
  }
  return tokens.join("||");
}

function syncPopupInventoryInspectorUi() {
  var syncToken = buildVisiblePopupInventoryInspectorSyncToken();
  var themeEnabled = !!state.themeEnabled;
  var inspectors;
  var i;

  if (!syncToken) {
    state.popupInventoryInspectorSyncToken = "";
    state.popupInventoryInspectorSyncEnabled = themeEnabled;
    return false;
  }

  if (state.popupInventoryInspectorSyncToken === syncToken &&
      state.popupInventoryInspectorSyncEnabled === themeEnabled) {
    return false;
  }

  inspectors = document.querySelectorAll(".basic_window.item_inspector_win");
  for (i = 0; i < inspectors.length; i += 1) {
    syncSingleInventoryInspector(inspectors[i]);
  }
  applyInlineThemeToVisibleItemInspectors(document);

  state.popupInventoryInspectorSyncToken = buildVisiblePopupInventoryInspectorSyncToken();
  state.popupInventoryInspectorSyncEnabled = themeEnabled;
  return true;
}
...
function ensureInventoryThemeRoot() {
  ...
  if (!rootVisible) {
    ...
    teardownInventoryInspectorEnhancer(document, false);
  ...
  function isQuickInjectedMenuEntry(entry) {
    ...
    try {
      return entry.getAttribute && entry.getAttribute("data-ModUiToolbox-quick") === "1";
  ...
  function createQuickMenuEntry(id, label, onClick, templateEntry) {
    ...
    li.setAttribute("data-ModUiToolbox-quick", "1");
  ...
  function runtimeModuleStorageKey(record, suffix) {
    return "ModUiToolbox.lua.runtime-module." + record.id + "." + String(suffix || "state");
  }
  ...
  function createRuntimeModuleContext(record) {
    ...
    var ctx = {
      ...
      addStyle: function (cssText, idSuffix) {
        ...
        if (idSuffix) {
          style.id = "ModUiToolbox-runtime-module-" + record.id + "-" + idSuffix;
        }
  ...
  function syncRuntimeModuleCheckbox(record) {
    var checkbox = document.getElementById("ModUiToolbox-runtime-module-checkbox-" + record.id);
    if (!checkbox) {
      return;
    }
  ...
  function syncRuntimeModuleRow(record) {
    var row = document.getElementById("ModUiToolbox-runtime-module-row-" + record.id);
    if (!row) {
      return;
    }
    ...
    var errorNode = row.querySelector(".ModUiToolbox-runtime-module-error");
    if (errorNode) {
  ...
  function syncRuntimeModuleMenuUi() {
    var button = document.getElementById("ModUiToolbox-runtime-module-button");
    var panel = document.getElementById("ModUiToolbox-runtime-module-panel");
    if (button) {
  ...
  function removeRuntimeModuleMenu() {
    var ids = [
      "ModUiToolbox-runtime-module-style",
      "ModUiToolbox-runtime-module-button",
      "ModUiToolbox-runtime-module-panel"
    ];
    for (var i = 0; i < ids.length; i += 1) {
      try {
  ...
  function ensureRuntimeModuleMenuUi() {
    ...
    var style = document.getElementById("ModUiToolbox-runtime-module-style");
    if (!style) {
      style = document.createElement("style");
      ...
      style.textContent = ""
        ...
        + ".ModUiToolbox-runtime-module-row:hover{background:rgba(255,255,255,.05);}"
        + ".ModUiToolbox-runtime-module-row[data-active='1']{background:rgba(39,119,93,.18);}"
        + ".ModUiToolbox-runtime-module-row[data-error='1']{background:rgba(138,49,49,.18);}"
        + ".ModUiToolbox-runtime-module-row input{margin-top:2px;flex:0 0 auto;}"
        + ".ModUiToolbox-runtime-module-meta{display:flex;flex-direction:column;gap:2px;min-width:0;margin-left:6px;}"
        + ".ModUiToolbox-runtime-module-name{font-weight:600;color:#eef7fb;}"
        + ".ModUiToolbox-runtime-module-desc{color:#9ab1bc;}"
        + ".ModUiToolbox-runtime-module-error{display:none;font-size:11px;color:#f2b4b4;word-break:break-word;}";
      (document.head || document.documentElement || document.body).appendChild(style);
    }
    ...
    if (!button) {
      ...
      button.id = "ModUiToolbox-runtime-module-button";
      button.type = "button";
      button.textContent = "⋮";
    ...
    if (!panel) {
      panel = document.createElement("div");
      panel.id = "ModUiToolbox-runtime-module-panel";
      panel.style.display = "none";
      panel.innerHTML = '<div class="ModUiToolbox-runtime-module-title">Runtime Modules</div><div id="ModUiToolbox-runtime-module-list"></div>';
    ...
    if (!state.runtimeModuleGlobalClickBound) {
      document.addEventListener("click", function (ev) {
        ...
        var liveButton = document.getElementById("ModUiToolbox-runtime-module-button");
        var livePanel = document.getElementById("ModUiToolbox-runtime-module-panel");
    ...
    var list = document.getElementById("ModUiToolbox-runtime-module-list");
    if (!list) {
      syncRuntimeModuleMenuUi();
      return;
    }
    ...
    if (!needsRebuild) {
      for (var checkIndex = 0; checkIndex < menuIds.length; checkIndex += 1) {
        if (!document.getElementById("ModUiToolbox-runtime-module-row-" + menuIds[checkIndex])) {
          needsRebuild = true;
          break;
        }
      }
    ...
    if (needsRebuild) {
      ...
      if (!menuIds.length) {
        ...
        empty.className = "ModUiToolbox-runtime-module-empty";
      ...
      for (var i = 0; i < menuIds.length; i += 1) {
        ...
        row.id = "ModUiToolbox-runtime-module-row-" + record.id;
        row.className = "ModUiToolbox-runtime-module-row";

        var checkbox = document.createElement("input");
        checkbox.type = "checkbox";
        checkbox.id = "ModUiToolbox-runtime-module-checkbox-" + record.id;
        checkbox.checked = !!record.enabled;
        ...
        meta.className = "ModUiToolbox-runtime-module-meta";

        var name = document.createElement("div");
        name.className = "ModUiToolbox-runtime-module-name";
        name.textContent = record.name;
        meta.appendChild(name);

        if (record.description) {
          var desc = document.createElement("div");
          desc.className = "ModUiToolbox-runtime-module-desc";
          desc.textContent = record.description;
          meta.appendChild(desc);
        }

        var error = document.createElement("div");
        error.className = "ModUiToolbox-runtime-module-error";
  ...
  function uninstallLuaEditorEnhancements() {
    ...
    var removableIds = [
      ...
      "ModUiToolbox-screen-buffer-size",
      "ModUiToolbox-screen-theme-dots",
      quickEditLuaMenuItemId,
  ...
  function uninstallProbe(reason) {
    ...
    try {
      window.__UI_TOOLBOX_LUA_PROBE_INSTALLED__ = false;
      delete window.__UI_TOOLBOX_LUA_PROBE_STATE__;
    } catch (_ignoreWindow) {}
