...
(function () {
  ...
  if (window.__UI_EXTRACTOR_LUA_RIG_BRIDGE__) {
    return;
  }
  window.__UI_EXTRACTOR_LUA_RIG_BRIDGE__ = true;

  var POLL_MS = 350;
  var UNKNOWN_PLAYER_ID = 0;
  var RIG_CONFIG = (window.__UI_EXTRACTOR_RIG_CONFIG && typeof window.__UI_EXTRACTOR_RIG_CONFIG === "object")
    ? window.__UI_EXTRACTOR_RIG_CONFIG
    : {};
  ...
  function injectProbe() {
    window.__UI_EXTRACTOR_LUA_PROBE_CONFIG = {
